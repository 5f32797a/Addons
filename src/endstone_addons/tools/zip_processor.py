...
def process_zip_recursive(zip_file: ZipFile, func, plugin, base_name: str):
    ...
    and calls the function for each. Now handles mixed-content archives.
    """
    # --- Pass 1: Find and process all manifests at the current level ---
    ...
    # --- Pass 2: Find and process all nested zip archives ---
    for zip_info in zip_file.infolist():
